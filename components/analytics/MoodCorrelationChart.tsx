...
import { calculateProductivityByMood } from '../../services/analytics';
...
const MoodCorrelationChart: React.FC<MoodCorrelationChartProps> = ({ tasks, moods, timeRange }) => {
  const chartRef = useRef<HTMLDivElement>(null);

  useEffect(() => {
    if (!chartRef.current || tasks.length === 0 || moods.length === 0) return;
