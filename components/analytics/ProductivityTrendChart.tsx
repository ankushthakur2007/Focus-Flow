...
import { groupTasksByDay, calculateDailyCompletionRates } from '../../services/analytics';
...
const ProductivityTrendChart: React.FC<ProductivityTrendChartProps> = ({ tasks, timeRange }) => {
