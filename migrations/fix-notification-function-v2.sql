-- Fix for the process_task_due_notifications function (version 2)
-- This addresses the syntax error in the previous fix
...
BEGIN
  ...
  LOOP
    ...
    -- Try to get user preferences, but don't fail if they don't exist
    BEGIN
