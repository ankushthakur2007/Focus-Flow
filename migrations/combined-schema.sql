...
-- Policies for productivity insights
DROP POLICY IF EXISTS "Users can view their own productivity insights" ON productivity_insights;
CREATE POLICY "Users can view their own productivity insights"
ON productivity_insights FOR SELECT
USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can insert their own productivity insights" ON productivity_insights;
CREATE POLICY "Users can insert their own productivity insights"
ON productivity_insights FOR INSERT
WITH CHECK (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can update their own productivity insights" ON productivity_insights;
CREATE POLICY "Users can update their own productivity insights"
ON productivity_insights FOR UPDATE
USING (auth.uid() = user_id);

DROP POLICY IF EXISTS "Users can delete their own productivity insights" ON productivity_insights;
